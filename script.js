            ...
            <form id="schedule-form">
                ...
                <div class="form-group" style="margin-top: 1.5rem;">
                    ...
                    <div class="checkbox-group">
                        ...
                        <label for="enable-schedule-notification">Ativar Notificações para este Horário</label>
                    </div>
                </div>
            </form>
        `;
